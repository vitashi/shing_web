...
export default class Products extends React.Component{
   ...
   render(){
      ...
      return (
              ...
              <Subheader style={{backgroundColor: '#3B5998', color: 'white', border: '2px solid', marginBottom: 5}} inset={true} >My Products</Subheader>
                   <GridList cols={3} cellHeight={180} padding={10} style={styles.gridList}>
